...
//Pin del Buzzer para que suene como alarma por si la temperatura aumenta demasiado (por si hay un incendio)
int buzzer = 7;
  ...
  switch(entrada){
    ...
    case 48: 
      ...
      temperatura(); //manda llmar al metodo que se debe ejecutar  
       delay(2000); // la duracion de la ejecucion
      break; 
    case 49: 
      //salida='1';
      //limpia la pantalla
...
void temperatura()
{
  ...
  if (tempC > 40){
    ...
    if (tempC > 24){
        ...
        digitalWrite(ledNaranja,LOW); //enciende el led naranja
